...
The main idea of this plugin is to visually take the latest or custom content like WordPress posts, pages, tagged content or custom post type and display it as a slider. Some additional themes are also available. This is definitively the best way to build a news page without coding anything. Build your news layout and let’s take care of your content only.
...
* Select your content source like a post category, page selection... 
...
* Advanced parameters for date format, custom css
...
**Update the free plugin, install the pro addon**
